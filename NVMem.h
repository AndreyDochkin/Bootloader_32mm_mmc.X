...
#define ROW_SIZE                256         // # of 32-bit Instructions per Row
#define BYTE_ROW_SIZE           (4 * ROW_SIZE) // # Row size in Bytes
#define NUM_ROWS_PAGE           8              //Number of Rows per Page 

#define NVMOP_WORD_PGM          0x4002      // Word program operation
...
extern "C" {
#endif
extern unsigned int NVMemWriteWord(void* address, unsigned int dLow, unsigned int dHigh);
